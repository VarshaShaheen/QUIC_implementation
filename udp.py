...
def main():
    ...
    """ In this loop, the script sends UDP packets up to the specified count.It attempts to send a packet and, 
    if successful, increments the sent counter.It also attempts to receive packets in non-blocking mode.If data is 
    received, the recv counter is incremented."""
